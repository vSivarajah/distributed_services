...
//and save the current size of the file in order to track amount of data in the index file as index entries are added.
...
//and the persisted file has flushed its contents to stable storage.
